...
//{
//    [TestClass]
//    public class MealBookingControllerTest : ControllerTest<MealBooking>
//    {
//        private const string path = "/api/Booking/Meal";

//        [TestMethod]
//        public void PostPutDeleteCompute()
//        {
//            reqCreator.CreateRequest(st, path, HttpMethod.Post, new MealBookingRepositoryTest().GetMealBookingById(1, 0), HttpStatusCode.OK, true, false);
