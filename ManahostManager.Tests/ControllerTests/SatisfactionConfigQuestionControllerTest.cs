...
//{
//    [TestClass]
//    public class SatisfactionConfigQuestionControllerTest : ControllerTest<SatisfactionConfigQuestion>
//    {
//        private const string path = "/api/Satisfaction/ConfigQuestion";

//        [TestMethod]
//        public void PostPutDelete()
//        {
//            reqCreator.CreateRequest(st, path, HttpMethod.Post, new SatisfactionConfigQuestionRepositoryTest().GetSatisfactionConfigQuestionByClientId(1, 1), HttpStatusCode.OK, true, false);
